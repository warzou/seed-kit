...
```text
wifi-kit-user ALL=(root) NOPASSWD: /bin/sh /path/to/modules/wifi-kit/prototype/wifi-kit-action-wrapper.sh start-ap-mode
wifi-kit-user ALL=(root) NOPASSWD: /bin/sh /path/to/modules/wifi-kit/prototype/wifi-kit-action-wrapper.sh return-default-network
```
